            ...
            if(from.text == "Your location"){
                Alamofire.request("http://ip-api.com/json").responseJSON { response in
                    ...
                    if let json = (response.result.value as? Dictionary<String, AnyObject>){
                        ...
                        var url:String? = "Web-env.m3uyi3cjpb.us-east-1.elasticbeanstalk.com/hw8/getNearby?location=\(self.myLat!),\(self.myLon!)&radius=\(radiusInMeter)&type=\(self.category.text!)&keyword=\(self.keyword.text!)"
                        print(url)
                ...
                var url : String!
                url = "Web-env.m3uyi3cjpb.us-east-1.elasticbeanstalk.com/hw8/geoNearby?location=\(self.from.text!)&radius=\(radiusInMeter)&type=\(self.category.text!)&keyword=\(self.keyword.text!)"
